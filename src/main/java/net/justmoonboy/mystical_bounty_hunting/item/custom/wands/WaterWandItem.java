...
public class WaterWandItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        if(Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip.mysticalbountyhunting.water_wand.shift_down"));
        } else {
            tooltipComponents.add(Component.translatable("tooltip.mysticalbountyhunting.water_wand"));
        }
