...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> CELLESTIUM_ARMOR_MATERIAL = register("cellestium",
            ...
            }), 16, 3.5f, 0.15f, () -> ModItems.CELLESTIUM_INGOT.get());


    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantibility, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(MysticalBountyHunting.MOD_ID, name);
