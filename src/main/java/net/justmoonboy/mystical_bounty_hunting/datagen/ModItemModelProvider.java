...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.CELLESTIUM_HELMET);
        trimmedArmorItem(ModItems.CELLESTIUM_CHESTPLATE);
        trimmedArmorItem(ModItems.CELLESTIUM_LEGGINGS);
        trimmedArmorItem(ModItems.CELLESTIUM_BOOTS);
    }

    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = MysticalBountyHunting.MOD_ID; // Change this to your mod id
